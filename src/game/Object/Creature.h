...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_NO_PARRY               = 0x00000004,       // 生物无法招架
    CREATURE_FLAG_EXTRA_NO_PARRY_HASTEN        = 0x00000008,       // 生物无法在招架时反击
    CREATURE_FLAG_EXTRA_NO_BLOCK               = 0x00000010,       // 生物无法格挡
    CREATURE_FLAG_EXTRA_NO_CRUSH               = 0x00000020,       // creature can't do crush attacks
    CREATURE_FLAG_EXTRA_NO_XP_AT_KILL          = 0x00000040,       // 生物被击杀不提供经验值
    CREATURE_FLAG_EXTRA_INVISIBLE              = 0x00000080,       // 生物对玩家来说总是不可见（主要是触发生物）
    CREATURE_FLAG_EXTRA_NOT_TAUNTABLE          = 0x00000100,       // 生物对嘲讽免疫
    CREATURE_FLAG_EXTRA_AGGRO_ZONE             = 0x00000200,       // 生物共享仇恨（即当攻击了一群生物其中一个，其余也会加入战斗）
    CREATURE_FLAG_EXTRA_GUARD                  = 0x00000400,       // 生物是守卫
    CREATURE_FLAG_EXTRA_NO_CALL_ASSIST         = 0x00000800,       // 生物不共享仇恨
